...
namespace ReportsCoreSamples.Models
{
    public class Globals
    {
        ...
        public static string REPORT_CONTROL_ID;
        public Globals(IHttpContextAccessor _context, IWebHostEnvironment hostingEnvironment)
        {
            ...
            isPuppeteerExist = File.Exists(Path.Combine(hostingEnvironment.WebRootPath, "puppeteer", "Win-901912", "chrome-win", "chrome.exe"));
